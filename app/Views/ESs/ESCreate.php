...
<?= $this->section('pageName') ?> Creation de ES <?= $this->endSection() ?>
...
<form id="form" method="post" enctype="multipart/form-data" action="<?= base_url() . 'ESs/M/add'?>">

    <input name="file_img" type="file" class="form-control" id="file_img" hidden>
    <img id="thumnail-project" class="img-thumnail" src="<?= base_url() . 'Images/ESs/Project_place_holder.png'?>"/>
...
<button id="btn-save" class="btn btn-primary" type="submit" >Cree ES </button>
</form>
